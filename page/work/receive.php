...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_query($conn, $sql_update)) {
        $message = "คืนชุดรหัส $Dressed_No เสร็จสิ้น"; // แจ้งเตือนข้อความสำเร็จ
    } else {
        ...
        <div class="main-panel"> <!-- เนื้อหาอยู่ในส่วนนี้ -->
            <div class="container mt-5">
                ...
                <div class="card mb-5">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div class="d-flex w-100 justify-content-between py-2 py-md-0">
                            ...
                            <a href="return_list.php?BookingH_No=<?= $bookingH_No ?>" class="btn btn-label-info btn-round me-4 mt-3">
                                <i class="fas fa-box-open"></i> เบิกชุด
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="Dressed_No" class="form-label">เลือกชุดที่คืน</label>
                            ...
                            <div class="mb-3">
                                <label for="Date_in" class="form-label">วันที่คืน</label>
                                <input type="date" class="form-control" name="Date_in" required>
                            </div>

                            <button type="submit" class="btn btn-success w-100">บันทึกการคืนชุด</button>
                        </form>
                ...
                <div class="mb-4 ms-4 text-left ">
                    ...
                    <button class="btn btn-warning text-white filter-button" data-status="เบิกชุดแล้ว">เบิกชุดแล้ว</button>
